...
HD_PWD='C:/Users/marti/OneDrive/CVUT/Semester5/PNO/GITLAB/Semestralka2_KeyboardToDisplay/Key2Disp/Key2Disp.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Key2SegDisp.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Key2SegDisp.tcl -notrace
