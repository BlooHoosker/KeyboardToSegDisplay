...
HD_PWD='C:/Users/marti/OneDrive/CVUT/Semester5/PNO/GITLAB/Semestralka2_KeyboardToDisplay/Key2Disp/Key2Disp.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Key2SegDisp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Key2SegDisp.tcl
